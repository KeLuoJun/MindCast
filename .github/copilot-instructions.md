...
Multi-agent podcast generator. Fetches topic-based news via Tavily, generates Chinese dialogue with 4 LangGraph agents, synthesizes voice with MiniMax TTS, serves via FastAPI + Vue 3.
...
- Frontend brand name: "MindCast"; stack credit: "基于 LangGraph + MiniMax TTS".
